...
export default function Contact() {
    const numberOfAlbums = initialAlbums.length;
  ...
  return (
    <div style={{ minWidth: '22rem' }}>
      ...
      <div className='d-flex justify-content-between align-items-center mb-3'>
        <h5 >{numberOfAlbums} Contacts <CiFilter style={{color:"blue"}} />  <IoMdHelpCircle  style={{color:"blueviolet"}}/>  </h5>
        <div>
      ...
      <MDBListGroup light>
        {displayedAlbums.map((album) => (
          ...
          >
            ...
            {/* <MDBBadge pill light color={album.badgeColor}>
              {album.status}
            </MDBBadge> */}
          </MDBListGroupItem>
        ))}
